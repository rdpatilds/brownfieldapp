...
const mockRepository = {
  findById: vi.fn<(id: string) => Promise<Project | undefined>>(() => Promise.resolve(undefined)),
  findBySlug: vi.fn<(slug: string) => Promise<Project | undefined>>(() =>
    Promise.resolve(undefined),
  ),
  findByOwnerId: vi.fn<(ownerId: string) => Promise<Project[]>>(() => Promise.resolve([])),
  findByIdAndOwner: vi.fn<(id: string, ownerId: string) => Promise<Project | undefined>>(() =>
    Promise.resolve(undefined),
  ),
  create: vi.fn<(data: unknown) => Promise<Project>>(() => Promise.resolve({} as Project)),
  update: vi.fn<(id: string, data: unknown) => Promise<Project | undefined>>(() =>
    Promise.resolve(undefined),
  ),
  deleteById: vi.fn<(id: string) => Promise<boolean>>(() => Promise.resolve(false)),
  countByOwnerId: vi.fn<(ownerId: string) => Promise<number>>(() => Promise.resolve(0)),
};

// Mock the repository before importing service
vi.mock("../repository", () => mockRepository);
